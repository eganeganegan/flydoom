...
if __name__ == "__main__":
    ...
    graph = nx.from_pandas_edgelist(
        sampled, "pre_body_id", "post_body_id", "synapse_count", create_using=nx.DiGraph
    )
    summary = {
        ...
        "cell_types": connectome.neurons.type.value_counts().head(20).to_dict(),
        "regions": connectome.neurons.region.value_counts().head(20).to_dict(),
