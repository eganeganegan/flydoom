...
def test_matched_controls_preserve_requested_properties() -> None:
    ...
    original_out = graph.edges.pre_body_id.value_counts().sort_index()
    rewired_out = rewired.edges.pre_body_id.value_counts().sort_index()
    original_in = graph.edges.post_body_id.value_counts().sort_index()
    rewired_in = rewired.edges.post_body_id.value_counts().sort_index()
